---
title: Hardening an OpenClaw VPS - Zero Trust Setup with Tailscale
date: 2026-02-28
...
The `recidive` jail watches fail2ban's own log. Any IP that gets banned 3 or more times within 24 hours is blocked on **all ports** for 7 days, which catches scanners that rotate through different exploits.
